...
const Avatar = ({ onPress, onlyAvatar, ...props }) => {
	const {
		globalState: {
			user: { firstName, lastName, profileImageUri },
		},
		updateUser,
	...
	if (onlyAvatar) {
		return (
			<Pressable onPress={onPress}>
				{profileImageUri && <Image source={{ uri: profileImageUri }} style={styles.avatarImage} {...props} />}
				{!profileImageUri && (
	...
	return (
		<View>
			...
			<View style={styles.container}>
				{profileImageUri && <Image source={{ uri: profileImageUri }} style={styles.avatarContainer} {...props} />}
				{!profileImageUri && (
